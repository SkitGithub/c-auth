    ...
    if (e.length > 0)
        for (let n = 0; n < e.length; n++) {
            ...
            for (let e = 0; e < a.length; e++) {
                const t = a[e],
                    n = {};
                n.currency = t.parentNode.querySelector(".iy"), n.amount = t.parentNode.querySelector(".pricing-item-price-amount"), n.after = t.parentNode.querySelector(".pricing-item-price-after"), n.data = JSON.parse(t.getAttribute("data-price-output")), l.push(n)
            }
